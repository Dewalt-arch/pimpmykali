...
#
# Rev 0.3 put all color prompts into a inline script variable 
...
check_distro() { 
     distro=$(uname -a | grep -i -c "kali") #CHANGE THIS TO "kali"
...
fix_golang () {
    ...
    echo -e "\n $greenplus .bashrc in /home/kali/.bashrc and /root/.bashrc updated \n"
    }
